...
export const Sidebar: React.FC = () => {
  ...
  const renderChannelItem = (channelKey: string) => {
    ...
    return (
      <div key={channelKey} className={`rounded-2xl overflow-hidden transition-all bg-white border border-[#EDE8F8] shadow-3xs hover:border-[#DDD6FE] hover:shadow-2xs ${
        ...
        >
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <span className="truncate text-left font-extrabold text-[#1E122C] group-hover:text-[#7C3AED] text-xs">
              {config.title}
            </span>
          </div>
  ...
  return (
    <aside 
      className="hidden lg:flex flex-col w-64 border-r border-[#EDE8F8] bg-[#FAF8FE] h-screen fixed left-0 top-0 z-30 select-none overflow-hidden"
    >
      {/* 1. Brand Header */}
      <div className="flex items-center gap-3 px-5 h-20 border-b border-[#EDE8F8] relative z-10 bg-[#FAF8FE] shrink-0">
        ...
        <div className="min-w-0">
          ...
          <span className="text-[10px] text-[#7C3AED] font-bold block leading-none pt-0.5">
            GrowWise AI
          </span>
        </div>
      </div>
      ...
      <div className="p-3.5 border-t border-[#EDE8F8] space-y-2 relative z-10 bg-[#FAF8FE] shrink-0">
        {/* Ask GrowWise AI Pill Button */}
        <button
          onClick={() => setAssistantOpen(true)}
          className="w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl text-xs font-bold text-[#1E122C] bg-white hover:bg-[#FAF7FF] transition-all border border-[#EDE8F8] hover:border-[#7C3AED]/40 shadow-3xs hover:shadow-2xs cursor-pointer group"
        >
          <div className="w-6 h-6 rounded-xl bg-[#F5F0FF] border border-[#E0D4FA] flex items-center justify-center shrink-0 overflow-hidden p-0.5 group-hover:scale-105 transition-transform">
            <img src="/growwise-icon.png" alt="GrowWise AI" className="w-full h-full object-contain" />
          </div>
          <span className="font-extrabold text-[#1E122C] group-hover:text-[#7C3AED] transition-colors">Ask GrowWise AI</span>
        </button>
        ...
        <div className="pt-0.5">
          <div className="flex items-center justify-between p-2 rounded-2xl bg-white border border-[#EDE8F8] shadow-3xs cursor-pointer hover:border-[#7C3AED]/40 transition-all">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#7C3AED] to-[#EC4899] text-white flex items-center justify-center font-black text-xs shrink-0 shadow-2xs">
                {brandName.charAt(0)}
              </div>
